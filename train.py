...
def process_images(image, label):
    ...
    image = tf.image.resize(image, (224,224)) #Resize from 32,32 to wanted size
    return image, label
...
#AlexNet(train_ds, epochs=10) #227x227
#VGG16(train_ds, epochs=10) #224x224
#VGG19(train_ds, epochs=10) #224x224
#SqueezeNet(train_ds, epochs=60) #227x227
#LeNet(train_ds, epochs=10) #32x32
#ZFNet(train_ds, epochs=10) #32x32
#NFNet_F2(train_ds, epochs=10) #32x32
#ColorNet(train_ds, epochs=10) #125x125
#---------------------------------------------------------------------------------------------------------
#
#
#-------------------------------------ResNet-Structures---------------------------------------------------
...
#WideResNet(train_ds, epochs=10) #32x32
#ResNet_1(train_ds, epochs=10, depth=152) #32x32
#ResNet_2(train_ds, epochs=10, depth=200) #32x32
#---------------------------------------------------------------------------------------------------------
#
#
